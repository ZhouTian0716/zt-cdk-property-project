...
import { S3Origin } from "aws-cdk-lib/aws-cloudfront-origins/lib/s3-origin";
...
export class UiDeploymentStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const deploymentBucket = new Bucket(this, "uiDeploymentBucket", {
      bucketName: `crm-front-end-${suffix}`,
    });

    const uiDir = join(__dirname, "..", "..", "..", "..", "crm-front-end", "dist");
    if (!existsSync(uiDir)) {
    ...
    const distribution = new Distribution(this, "crm-front-end-distribution", {
    ...
    new CfnOutput(this, "crm-front-end-url", {
